...
export const metadata: Metadata = {
  title: 'Terms of Service - Diecasts',
  description: 'Terms of Service for Diecasts - F1 Diecast Price Comparison',
};
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="font-display font-bold text-[32px] text-[var(--text-primary)] mt-8 mb-4">1. About Diecasts</h2>
            <p className="mb-4">
              Diecasts is a price comparison platform for F1 diecast models. We aggregate publicly available pricing information from various online retailers to help collectors find the best deals.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              <strong>All prices displayed on Diecasts are indicative only and may not reflect current retail prices.</strong>
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Diecasts does not sell products. We are purely a comparison tool. All purchases must be made directly with retailers. We are not responsible for:
            </p>
            <ul className="space-y-3 list-disc list-inside mb-4">
