...
const EVENT_SYNONYMS = {
  'portuguesegp': ['Portugal', 'Portugese', 'Portimao'],
  'bahraingp': ['Bahrein', 'Sakhir Bahrain'],
  'frenchgp': ['Franse', 'France', 'Paul Ricard'],
  'turkishgp': ['Turkse', 'Turkey', 'Istanbul', 'Türkiye', 'Turkiye'],
  'italiangpmonza':          ['Italian', 'Italy', 'Monza', 'Italy Monza', 'Italien', 'Italiaanse'],
  'emiliaromagnagpimola':    ['Emilia Romagna', 'Emilia-Romagna', 'Imola', 'Emilia', 'Emiliaanse'],
  'unitedstatesgpaustin':    ['United States', 'USA', 'US', 'Austin', 'US Austin', 'COTA', 'Americas', 'Amerikaanse'],
  ...
  'brazoliangp':             [],
  'braziliangp':             ['Brazil', 'Interlagos', 'Sao Paulo', 'Braziliaanse'],
  'belgiangp':               ['Belgium', 'Spa', 'Belgium SPA', 'Belgische'],
  'saudiarabiangp':          ['Saudi', 'Saudi Arabia', 'Jeddah', 'Saoedische', 'Saudi Arabie'],
  'japanesegp':              ['Japan', 'Suzuka', 'Japanse'],
  'chinesegp':               ['China', 'Shanghai'],
  'canadiangp':              ['Canada', 'Montreal'],
  'mexicangp':               ['Mexico', 'Mexicaanse'],
  'mexicocitygp':            ['Mexico City'],
  'australiangp':            ['Australia', 'Melbourne', 'Albert Park', 'Australische'],
  'spanishgp':               ['Spain', 'Barcelona', 'Catalunya', 'Spanje', 'Spaanse'],
  'austriangp':              ['Austria', 'Red Bull Ring', 'Spielberg', 'Oostenrijkse'],
  'hungariangp':             ['Hungary', 'Hungaroring', 'Budapest', 'Hongaarse'],
  'britishgp':               ['Britain', 'Great Britain', 'Silverstone', 'UK', 'Britse'],
  'dutchgp':                 ['Netherlands', 'Holland', 'Zandvoort', 'Nederlandse', 'Nederland'],
  'azerbaijangp':            ['Baku'],
  'russiangpsochi':          ['Russia', 'Russian', 'Sochi', 'Russische', 'Sotchi'],
  'eifelgpnurburgring':      ['Eifel', 'Nurburgring', 'Nürburgring'],
  'tuscangpmugello':         ['Tuscan', 'Tuscany', 'Mugello'],
  'abudhabigp':              ['Abu Dhabi', 'Yas Marina'],
  'qatargp':                 ['Losail', 'Lusail', 'Qatarese'],
  'lasvegasgp':              ['Vegas'],
  'monacogp':                ['Monte Carlo', 'Monegaskische'],
